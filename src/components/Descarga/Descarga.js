  ...
  return (
    <section className='descarga-bkg py-1'>
      <div className='container text-center text-md-start'>
        <h2 className='d-block d-lg-none fw-bold title'>Opera cuando quieras y donde quieras!</h2>
        ...
        <div className='d-flex align-items-center flex-column flex-md-row'>
          ...
          <div className='pe-lg-5'>
            <h2 className='descarga-title d-none d-lg-block fw-bold title'>Opera cuando quieras y donde quieras!</h2>
